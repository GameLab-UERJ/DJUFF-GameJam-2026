...
var pictures : Dictionary[String,Texture2D] = {
	"Golem1" : load("uid://cr4yokkhs3she"),
	"Golem2" : load("uid://dkipy57mjpod3"),
	"Boss"   : load("uid://bfg11kgvdi78w")
}
...
## The picture of the currently speaking character
...
func apply_dialogue_line() -> void:
	...
	picture.texture = pictures.get(character_label.text)
